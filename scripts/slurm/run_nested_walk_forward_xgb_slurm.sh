#!/bin/bash
#SBATCH --job-name=nba_nested_wf_xgb
...
#
# Submit example:
#   sbatch scripts/slurm/run_nested_walk_forward_xgb_slurm.sh
#   sbatch scripts/slurm/run_nested_walk_forward_xgb_slurm.sh \
#     --input data/analysis/shotchoice_panel_clutch_rs.parquet \
#     --outdir results/nested_wf_xgb
...
echo "================================================================================"
echo "Nested walk-forward (SLURM): XGBoost"
echo "================================================================================"
...
echo "XGBoost run completed successfully."
